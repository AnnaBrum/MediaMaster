  ...
  useEffect(() => {
    const getData = async () => {
      ...
      if (mySub) {
        ...
        setUsers(mySub[0].amount_of_users);
        setStartDate(Date.parse(mySub[0].billing_start_date));
        // console.log(mySub[0].billing_start_date);
        ...
        if (currentSubscriptions) {
          ...
          setPricePlanLabel(
            `${currentSubscriptions[0].plan_name} ${currentSubscriptions[0].price} kr`
          );
